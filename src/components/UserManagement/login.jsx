    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-100 via-white to-orange-50 px-4">
      ...
      >
        <motion.h2
          ...
          className="text-3xl font-extrabold text-center mb-6 bg-gradient-to-r from-orange-500 to-red-400 bg-clip-text text-transparent"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="relative">
            ...
            <input
              type="email"
              placeholder="Email"
              className="w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-orange-400 focus:border-orange-400 outline-none transition"
              value={form.email}
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            type="submit"
            className="w-full bg-gradient-to-r from-orange-500 to-red-400 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition"
          >
            Login
          </motion.button>
        </form>
